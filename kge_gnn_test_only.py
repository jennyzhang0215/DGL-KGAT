...
def parse_args():
    ...
    save_dir = "test_unif{}_{}_kg{}_pre{}_d{}_l{}_dp{}_lr{}_bz{}_kgbz{}_att{}_jt{}_seed{}".format(
                int(args.uniform_sample), args.data_name, 1, int(args.use_pretrain),
...
def train(args):
    ...
    for epoch in range(1, args.max_epoch+1):
        if args.joint_train:
            ...
            for iter in range(total_iter):
                ...
                embedding = model.gnn(test_g, test_g.ndata['id'])
        ...
        if epoch % args.evaluate_every == 0:
            time1 = time()
            val_recall, val_ndcg = eval(model, test_g, dataset.train_user_dict, dataset.test_user_dict,
    ...
    logging.info("Final best test recall:{:.5f}, test ndcg:{:.5f}, best epoch:{}".format(
        best_recall, best_ndcg, best_epoch))

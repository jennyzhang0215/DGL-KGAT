...
def eval(all_embedding, train_user_dict, eval_user_dict, item_id_range):
    with th.no_grad():
...
if __name__ == '__main__':
    ...
    val_recall, val_ndcg = eval(embeds, dataset.train_user_dict, dataset.valid_user_dict, item_id_range)
    test_recall, test_ndcg = eval(embeds, dataset.train_user_dict, dataset.test_user_dict, item_id_range)
